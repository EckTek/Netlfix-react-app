        ...
        <div className="featured--vertical">
            <div className="featured--horizontal">
                ...
                <div className="featured--buttons">
                    <a href="/#" disabled className="featured--watchbutton"><div><PlayArrowIcon /> Assitir</div></a>
                    <a href="/#" disabled className="featured--mylistbutton"><div><AddIcon />Minha Lista</div></a>
                </div>
